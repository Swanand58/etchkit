    ...
    return (
      <Button
        ...
        className={cn(
          ...
          orientation === 'horizontal' ? '-left-10 top-1/2 -translate-y-1/2' : '-top-10 left-1/2 -translate-x-1/2 rotate-90',
          className
        )}
  ...
  ({ className, variant = 'outline', size = 'sm', ...props }, ref) => {
    ...
    return (
      <Button
        ...
        className={cn(
          'absolute h-8 w-8 p-0',
          orientation === 'horizontal' ? '-right-10 top-1/2 -translate-y-1/2' : '-bottom-10 left-1/2 -translate-x-1/2 rotate-90',
          className
        )}
